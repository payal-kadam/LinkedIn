                ...
                <DashboardLayout>
                    <div className={styles.scrollcomponent}>
                         <div className={styles.wrapper}>
                            ...
                            alt="profile"
                            />
                            <textarea onChange={(e)=>setPostContent(e.target.value)} value={postcontent}
                            placeholder={ "What's in your mind ?"} className={styles.textarea} name="" id=""></textarea>
                            ...
                            <input  onChange={(e)=>setFileContent(e.target.files[0])}
                                            ...
                                            <div className={styles.singleCard__profileContainer}>
                                                ...
                                                <div>
                                                    ...
                                                    <div className={styles.singleCard__image}>
                                                        <img src={`${BASE_URL}/${post.media}`} alt="post"></img>
                                                    </div>
                                                    ...
                                                    <div className={styles.optionscontainer}>
                                                        ...
                                                        <div className={styles.singleoption__optionscontainer}>
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
